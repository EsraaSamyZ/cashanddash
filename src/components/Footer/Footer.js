      ...
      <div className="bg-midnight-blue">
        <div className="text-center py-8 md:py-16 space-y-12 md:space-y-24">
          ...
          <div className="md:space-x-3 md:space-y-0 space-y-3 flex flex-col md:flex-row justify-center items-center">
            <ContactUsBtn className="text-xl text-dark-gray bg-white border border-dark-gray hover:text-white hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-bold rounded-md text-sm px-8 py-3 text-center w-56" />
