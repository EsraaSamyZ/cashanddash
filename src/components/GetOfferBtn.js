...
const GetOfferBtn = () => {
    return (
        <>
            <button type="button" className="text-white bg-deep-crimson hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-semibold rounded-md text-sm px-5 py-2 text-center inline-flex items-center justify-center">
                Get Offer
                <ArrowIcon />
            </button>
        </>
